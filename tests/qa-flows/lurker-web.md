...
4. Verificar `/penca/libertadores-semana` renderea:
...
6. Visitar un slug inexistente como `/penca/no-existe` → themed 404, no
...
- 404 themed siempre que la URL sea bajo `/penca/`.
