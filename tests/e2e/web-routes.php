<?php
/**
 * Public web frontend: every /penca/* route renders the right surface
...
foreach ( Mantia_Competitions::all() as $c ) {
	...
	Mantia_E2E::assert_http_ok( "/penca/{$slug}/", array( $c['name'], 'Crear penca' ) );
}
...
Mantia_E2E::assert_http_ok( "/penca/g/{$token}/", array( 'WebTest', 'Sumate' ) );
...
Mantia_E2E::assert_http_status( '/penca/me/0000000000000000/', 404, array( 'no funciona' ) );

Mantia_E2E::step( '6. Unknown competition slug' );
Mantia_E2E::assert_http_status( '/penca/competencia-que-no-existe/', 404 );
